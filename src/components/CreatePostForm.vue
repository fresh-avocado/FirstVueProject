<template>
     <div class="new-post-form">
          <form>
               <input v-model="title" placeholder="Post Title..." class="post-title form-element" required>
               <!-- <span class="error" v-if="!$v.postTitle.required">Post title is required.</span> -->
               <textarea v-model="description" placeholder="Post Description..." class="post-description form-element" required></textarea>
               ...
               <!-- Como agarrar el texto de los X text fields que el usuario ha creado dinamicamente? -->
               ...
               <div v-if="selectedTopic" class="subtopic-dropdown form-element">
                    <h3>Subtema:</h3>
                    <select v-model="selectedSubtopic" required>
          ...
          uploadPost() {
               axios({
                    ...
                    if (response.status == 200) {
                         ...
                         alert('Ocurrió un error. El Post no se pudo subir.');
                    }
               });
          }
     }
